package com.example.travelassistant.my_trips
...
import com.example.travelassistant.rating.RateTripActivity
...
class TripsFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        if(accountId != -1) {
            val parisImageView = view.findViewById<ImageView>(R.id.parisImageView)
...
//            startActivity(intent)
    ...
    private fun showNotLoggedInDialog(view: View) {
        ...
        builder.setTitle("Cannot view Trips")
            .setMessage("Please Sign In in order to view your past Trips")
